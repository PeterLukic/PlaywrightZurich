...
test.describe('OrangeHRM Login', () => {
  ...
  test('Login with demo credentials', { tag: ['@ui', '@smoke', '@positive'] }, async ({ When, pageManager, Then }) => { 
